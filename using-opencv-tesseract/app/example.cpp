...
//     file = fopen("/opt/app/eng.traineddata", "r");
    ...
    else
    {
        ...
        cout << "File does not exists /usr/local/packages/opencv_tesseract_app/eng.traineddata" << endl;
        exit(1);
    }
    while (true) {
        ...
        // tess.Init(NULL, "eng"); // Remplacez "eng" par la langue de votre choix
        //
